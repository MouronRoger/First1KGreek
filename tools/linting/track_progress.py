...
def track_progress(files):
    ...
    for i, file_path in enumerate(files):
        ...
        is_fully_compliant = (
            is_black_compliant
            and is_flake8_compliant
            and is_isort_compliant
            and is_critical_free
            and is_docstring_compliant
        )
...
def main():
    ...
    parser.add_argument("--directories", nargs="+", default=["src"], help="Directories to scan (default: src)")
    parser.add_argument("--exclude", nargs="+", default=[], help="Glob patterns to exclude")
    parser.add_argument("--output", default="lint_reports/progress.json", help="Output file for detailed report")
    parser.add_argument("--detailed", action="store_true", help="Show detailed information about non-compliant files")
