...
def get_python_files(directory):
    ...
    return [
        f for f in glob.glob(f"{directory}/**/*.py", recursive=True)
...
def main():
    ...
    parser.add_argument("--select", default="D100,D101,D102,D103", 
                        help="Docstring error codes to check (comma-separated)")
